    ...
    const result = json({
      bottomBanners: await Promise.all(bottomBanners.map(async (bottomBanner: any) => {
        ...
        return {
          ...
          actionButtonText: (bottomBanner as any).actionButtonText || ((bottomBanner as any).actionType === "buy_now" ? "Buy Now" : (bottomBanner as any).actionType === "add_to_cart" ? "Add to Cart" : "View Product"),
