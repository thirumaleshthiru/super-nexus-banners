  ...
  try {
    ...
    if (activeTest && activeTest.variants.length > 0) {
      ...
      bannerSettings = {
        ...
        button1BorderColor: selectedVariant.buttonBorderColor,
        ...
        button2BorderColor: selectedVariant.buyNowButtonBorderColor,
    ...
    return json({
      ...
      settings: bannerSettings ? {
        ...
        bannerBackgroundColor: bannerSettings.bannerBackgroundColor,
        bannerBorderRadius: bannerSettings.bannerBorderRadius,
        button1Text: bannerSettings.button1Text,
        ...
        button2Text: bannerSettings.button2Text,
        ...
        hurryUpText: bannerSettings.hurryUpText,
