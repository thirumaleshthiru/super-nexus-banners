...
CREATE TABLE "new_ProductBannerVariant" (
    ...
    "buttonBorderColor" TEXT NOT NULL DEFAULT 'FF6B6B',
    ...
    "buyNowButtonBorderColor" TEXT NOT NULL DEFAULT 'FF6B6B',
...
INSERT INTO "new_ProductBannerVariant" ("addToCarts", "bannerBackgroundColor", "bannerBorderRadius", "bannerHeight", "bannerImageHeight", "bannerPadding", "bannerPriceColor", "bannerTextColor", "buttonBackgroundColor", "buttonBorderRadius", "buttonFontSize", "buttonHeight", "buttonText", "buttonTextColor", "buyNowButtonBackgroundColor", "buyNowButtonBorderRadius", "buyNowButtonFontSize", "buyNowButtonHeight", "buyNowButtonText", "buyNowButtonTextColor", "buyNows", "clicks", "conversionRate", "conversions", "createdAt", "hurryUpBackgroundColor", "hurryUpFontSize", "hurryUpHeight", "hurryUpText", "hurryUpTextColor", "id", "isControl", "isShowAddToCartButton", "isShowBuyNowButton", "isShowHurryUpBanner", "isShowPrice", "name", "priceFontSize", "pricePosition", "testId", "trafficWeight", "updatedAt", "views") SELECT "addToCarts", "bannerBackgroundColor", "bannerBorderRadius", "bannerHeight", "bannerImageHeight", "bannerPadding", "bannerPriceColor", "bannerTextColor", "buttonBackgroundColor", "buttonBorderRadius", "buttonFontSize", "buttonHeight", "buttonText", "buttonTextColor", "buyNowButtonBackgroundColor", "buyNowButtonBorderRadius", "buyNowButtonFontSize", "buyNowButtonHeight", "buyNowButtonText", "buyNowButtonTextColor", "buyNows", "clicks", "conversionRate", "conversions", "createdAt", "hurryUpBackgroundColor", "hurryUpFontSize", "hurryUpHeight", "hurryUpText", "hurryUpTextColor", "id", "isControl", "isShowAddToCartButton", "isShowBuyNowButton", "isShowHurryUpBanner", "isShowPrice", "name", "priceFontSize", "pricePosition", "testId", "trafficWeight", "updatedAt", "views" FROM "ProductBannerVariant";
