/*
  ...
  - You are about to drop the column `productVariantId` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `productVariantId` on the `BannerSlide` table. All the data in the column will be lost.
...
INSERT INTO "new_BannerSlide" ("actionButtonText", "actionType", "bannerId", "createdAt", "endTime", "hasProduct", "id", "isTimer", "message", "order", "productId", "productImage", "productTitle", "startTime", "updatedAt") SELECT "actionButtonText", "actionType", "bannerId", "createdAt", "endTime", "hasProduct", "id", "isTimer", "message", "order", "productId", "productImage", "productTitle", "startTime", "updatedAt" FROM "BannerSlide";
DROP TABLE "BannerSlide";
ALTER TABLE "new_BannerSlide" RENAME TO "BannerSlide";
