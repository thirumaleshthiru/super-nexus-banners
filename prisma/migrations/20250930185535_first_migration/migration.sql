...
CREATE TABLE "BannerAnalytics" (
    ...
    CONSTRAINT "BannerAnalytics_bannerId_fkey" FOREIGN KEY ("bannerId") REFERENCES "Banner" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "BannerAnalytics_bannerId_eventType_idx" ON "BannerAnalytics"("bannerId", "eventType");

-- CreateIndex
CREATE INDEX "BannerAnalytics_timestamp_idx" ON "BannerAnalytics"("timestamp");

-- CreateIndex
CREATE INDEX "BannerAnalytics_shopDomain_idx" ON "BannerAnalytics"("shopDomain");
