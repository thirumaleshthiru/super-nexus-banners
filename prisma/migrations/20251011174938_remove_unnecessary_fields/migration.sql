/*
  ...
  - You are about to drop the column `closeIconColor` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `closeIconPosition` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `closeIconSize` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `position` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `responsiveDetails` on the `Banner` table. All the data in the column will be lost.
  - You are about to drop the column `responsiveFonts` on the `Banner` table. All the data in the column will be lost.
